...
export default function CallToAction() {
  ...
  return (
    <section
      ref={sectionRef}
      className="w-screen flex items-center flex-col gap-7 pt-20 md:pt-32 pb-20 md:pb-52 mt-20 overflow-hidden bg-gradient-to-b from-white to-[#D2DCFF]"
    >
      <SectionHeader
      ...
      <div className="relative flex gap-10 lg:text-2xl">
        ...
        <button className="flex items-center gap-1.5 group active:translate-y-0.5 border-2 border-black px-2.5 rounded-lg transition-colors text-black">
          Learn more
